...
import inspectorguidgetplugin.popup.actions.GUIListeners;
...
public class ListenerView extends ViewPart {
	...
	final static String			FILE		= "/Users/vlellile/Documents/GUIAnalysisTools/Test/CheckedListeners.txt";
	...
	private TableViewer makeTable(Composite parent) {
		...
		tableViewer.setLabelProvider(new LabelProvider() {
			...
			public String getText(Object element) {
				...
				String label = GUIListeners.getMethod((IMarker) element);
				if (label != null)
					return label;
		...
		tableViewer.addCheckStateListener(new ICheckStateListener() {
			...
			public void checkStateChanged(CheckStateChangedEvent event) {
				...
				String info = GUIListeners.getInfo(marker);
